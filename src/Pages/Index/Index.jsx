...
function Index () {
     ...
     const content =
       " Ми раді оголосити про нову захоплюючу можливість для талановитого та високомотивованого Data Scientist приєднатися до на...";
        ...
        // Function to clone the first vacancy
      
         const cloneVacancy = () => {
           const lastVacancy = vacancies[vacancies.length - 1];
           setVacancies([
             ...vacancies,
             { ...lastVacancy, id: vacancies.length + 1 },
           ]);
         };
           ...
           <main>
               ...
               <div className="t-bl-r-l-flex">
                 <div className="topic-block-left">
                   ...
                   <p className="text-left">
                     Найкращі шанси мають фахівці з досвідом комерційної роботи
                     від 5-ти років. Але якщо у вас менше років досвіду – ніщо
                     вас не обмежує, тільки не чекайте, що ми швидко зможемо
                     підібрати вам роботу.
                   </p>
                 </div>
                 ...
                 <div className="topic-block-right">
                   ...
                   <p className="text-right">
                     ...
                     закордонний роботодавець на зустрічах і самі могли
                     відповісти.
                   </p>
                 </div>
               </div>
             ...
             <div className="reviews-block">
               <div className="r-bl-wr">
                 ...
                 <p className="photo-desc">
                   У новій компанії я отримав посаду Senior PHP Developer. Я
                   добре ціную процес пошуку та відбору вакансій через
                   Buxonline. Це була перша вакансія, запропонована розвідником,
                   і я пішов на неї. Я вважаю, що Марина добре розуміє потреби і
                   вміє підбирати вакансії, які відповідають навичкам і
                   очікуванням фахівців. Якість під
                 </p>
               </div>
               <div className="r-bl-wr">
             ...
             <div className="scheme-block">
               <div className="scheme-1">
                 <div className="wr-sch-1">
                   ...
                   <p>
                     Ми перевіряємо ваше резюме. Знаходимо вам відповідну
                     компанію. Тому це може зайняти якийсь час.
                   </p>
                 </div>
                 <img
               ...
               <div className="scheme-2">
                 <div className="wr-sch-2">
                   ...
                   <p>
                     Після спілкування ми надішлемо вам анкету, де ви відмітите
                     ті речі, які вам однозначно не підходить. Наприклад робота
                     у дейтингу. А також відзначите те, що вас найбільше
                     приваблює: ненормований робочий день інше...
                   </p>
                 </div>
                 <img
                   src={indexChatImg}
               ...
               <div className="scheme-3">
                 <div className="wr-sch-3">
                   ...
                   <p>
                     ...
                     зайняти досить великий проміжок часу. Але ви точно
               ...
               <div className="scheme-4">
                 <div className="wr-sch-4">
                   ...
                   <p>
                     ...
                     інтер’ю, де ми поспілкуємось і дізнаємося одне одного
                     краще.
                   </p>
                 </div>
                 <img
               ...
               <div className="scheme-5">
                 <div className="wr-sch-5">
                   ...
                   <p>
                     Педставник Компанії з вами поспілкуватися через зум для
                     того, щоб домовитися.
                   </p>
                 </div>
                 <img
               ...
               <div className="scheme-7">
                 <div className="wr-sch-7">
                   ...
                   <p>
                     ...
                     працевлаштування. Ознайомтеся, запитайте та підпишіть
                     договір для початку роботи віддалено.
                   </p>
                 </div>
               </div>
             ...
             <div className="advantages-block">
               ...
               <div className="a-4">
                 <span>4</span>
                 <p>
                   Ми знайдемо ідеальну роботу, що відповідає вашим навичкам
                 </p>
               </div>
               <div className="a-5">
                 <span>5</span>
               ...
               {vacancies.map((vacancy) => (
                 <div className="v-bl-slide" key={vacancy.id}>
                   ...
                   <div className="v-bl">
                     ...
                     <p>{truncateText(vacancy.content, 121)}</p>
                   </div>
