            ...
            <>
                ...
                <div className="form-wrapper">
                    <form>
                        ...
                        <InputField label='Підтвердіть пароль' type='password' placeholder='Підтвердіть пароль' id='passwprd'></InputField>
        ...
        <>
            ...
            <div className="form-wrapper">
                <form>
                    ...
                    <input ref={emailRef} label='E-mail' type='email' placeholder='E-mail' id='email' className='forgot-password'></input>
                    <SolidButton type='button' fontSize={16} onClick={handleEmail}>Далі</SolidButton>
                </form>
            </div >
        </>
    )
