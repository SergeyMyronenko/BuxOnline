            ...
            <div className="social-media">
              <a href="#" className="link-linkedin">
                <IconContext.Provider
                  value={{ color: "white", className: "contact-icon" }}
                >
                  <SlSocialLinkedin />
                </IconContext.Provider>
              </a>
